                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{__(('dashboard.Guardian'))}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.update.parent',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('Teacher_trans.Username_ar') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('Teacher_trans.Username_en') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <label class="form-check-label"
                                               for="exampleCheck1">{{ trans('Teacher_trans.Show_Password') }}</label>
                                    </div>
                                </div>
                                <hr>
                                <button type="submit"
                                        class="btn btn-success">{{ trans('dashboard.Edit_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
