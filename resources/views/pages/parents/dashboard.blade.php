                                ...
                                <div class="card text-black">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-4">{{__('Students_trans.Student_information')}}</p>
                                        </div>
                                        <div>
                                            <div class="d-flex justify-content-between">
                                                <span>{{__('Students_trans.Grade')}}</span><span>{{$son->grade->Name}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <span>{{__('Students_trans.classrooms')}}</span><span>{{$son->classroom->Name_Class}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <span>{{__('Students_trans.section')}}</span><span>{{$son->section->Name_Section}}</span>
                                            </div>
