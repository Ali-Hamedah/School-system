                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{__('Students_trans.name')}}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="fee_id">
                                    @foreach($fees as $fee)
                                        <option
                                            value="{{$fee->id}}" {{$fee->id == $fee_invoices->fee_id ? 'selected':"" }}>{{$fee->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{__('grades_trans.Notes')}}</label>
