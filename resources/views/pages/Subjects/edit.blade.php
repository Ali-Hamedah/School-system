                            ...
                            <form action="{{route('subjects.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState">{{__('Students_trans.Grade')}}</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{__('Students_trans.classrooms')}}</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{__('Teacher_trans.Name_Teacher')}}</label>
