...
class ParentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $my_parents->email = 'ali.hamedah77@yahoo.com';
        $my_parents->password = Hash::make('12345678');
        $my_parents->Name_Father = ['en' => 'alihamedah', 'ar' => 'علي حميده'];
        ...
        $my_parents->Address_Father = 'انسبروك';
        ...
        $my_parents->Address_Mother = 'انسبروك';
        $my_parents->save();
